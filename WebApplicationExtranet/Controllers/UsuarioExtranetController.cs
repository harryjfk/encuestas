...
namespace WebApplication.Controllers
{
    ...
    public class UsuarioExtranetController : Controller
    {
        ...
        {
            //brb
            //decimal IdInformante = Manager.Usuario.FindUsuarioExtranet(user.Id).Identificador;
            //endbrb            

            decimal IdInformante = UsuarioActual.Identificador;

            ViewBag.UserId = IdInformante;
        ...
        {
            criteria.IdInformante = ((Establecimiento)Session["CriteriaEncuestas"]).IdInformante;
            Session["CriteriaEncuestas"] = criteria;
        ...
        //public ActionResult EstablecimientosEncuestaEstadistica(UserInformation user)
        //{
